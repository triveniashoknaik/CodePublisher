...
// Author:      Triveni Ashok Naik, Syracuse University, CST 4-187 //
//              trnaik@syr.edu                                     //
/////////////////////////////////////////////////////////////////////
...
int main(int argc, char* argv[])
{
  ...
  try {
    ...
    Rslt::write("\n");
    exec.stopLogger();
	std::cout << "\n  Code Analysis completed"; std::cout << "\n\n"; 
	std::cout << "=============================================== PROJECT 3: Dependency Based Code Publisher==============================================================================";
	std::cout << "\n\n"; std::cout << "\n\n";
	std::cout << "***************************************************************************************************************************************************************************";  std::cout << "\n\n";
	std::cout << "***************************************************************************************************************************************************************************";  std::cout << "\n\n";
	std::cout << "----------------------------------------------------------Demonstration of Requirement 1---------------------------------------------------------------------";	  std::cout << "\n\n"; std::cout << "\n\n";
	std::cout << "------------------------------------Used Visual Studio 2015 and its C++ Windows Console Projects, as provided in the ECS computer labs.----------------------------------";
	std::cout << "\n\n"; std::cout << "***************************************************************************************************************************************************************************";  std::cout << "\n\n";
	std::cout << "----------------------------------------------------------Demonstration of Requirement 2---------------------------------------------------------------------";
	std::cout << "\n\n";
	std::cout << " ------------------------------------Used the C++ standard library's streams for all I/O and new and delete for all heap-based memory management1----------------------------------";
	std::cout << "\n\n";	  std::cout << "***************************************************************************************************************************************************************************";  std::cout << "\n\n";
	std::cout << "----------------------------------------------------------Demonstration of Requirement 3--------------------------------------------------------------------------";
	std::cout << "\n\n";
	std::cout << "-----------------------------------Have been provided with a Publisher program that provides for creation of web pages------------------------------";
	std::cout << "\n\n"; std::cout << "***************************************************************************************************************************************************************************";  std::cout << "\n\n";
	std::cout << "----------------------------------------------------------Demonstration of Requirement 4-----------------------------------------------------------------------------------------------------";
	std::cout << "\n\n";
	std::cout << " ----------------------------------BONUS IMPLEMENTED: Facility to expand or collapse class bodies, methods, and global functions using JavaScript and CSS properties. ------------------------------------------------------------------------";
	std::cout << "\n\n";
	Dependency db; 
	...
	std::cout << "\n\n";std::cout << "***************************************************************************************************************************************************************************";  std::cout << "\n\n";
	std::cout << "\n\n";
	std::cout << "---------------------------------------- Provided a TypeAnalysis package that identifies all of the types defined in a specified file.--------------------------------------------";
	std::cout << "\n\n";	  std::cout << "\n\n";
	...
	typeanalysis db1;
	TypeAnal ta; db1 = ta.doTypeAnal();



	for (auto x : db1)
	{std::cout << "\n\n"; 
	std::cout << x.first << std::endl; std::cout << "\n\n";
		for (int i = 0; i < x.second.size(); i++) for (auto y : x.second[i])
		std::cout << y.first << "   =>  " << y.second << std::endl;}
	std::cout << "\n\n"; 	  std::cout << "***************************************************************************************************************************************************************************";  std::cout << "\n\n";
	std::cout << "\n\n";	  std::cout << "\n\n";  std::cout << "-----------------------------------Analyzing all the Dependencies of the file.(WILL TAKE SOME TIME)----------------------------------------------";
	std::cout << "\n\n";

	workdo w;
	db = w.taskDo(db1, db, allfiles);
	CodePublisher pa;
	pa.showhomepage("MyHtmlfiles.html");
	Files rt = db.keys();  	for (File k : rt)
	{std::cout << k << "     " << db.value(k).showelement();}
	std::cout << "----------------------------------------------------------Demonstration of Requirement 5------------------------------------------------------------------------------------------------------------";
	std::cout << "\n\n"; std::cout << "\n\n";  std::cout << "--------------------------------------Provided a Javascipt and CSS File to implement the hiding/unhiding feature----------------------------------------------";
	std::cout << "\n\n";
	std::cout << "\n\n"; 	  std::cout << "***************************************************************************************************************************************************************************";  std::cout << "\n\n";
	std::cout << "----------------------------------------------------------Demonstration of Requirement 6---------------------------------------------------------------------------------------------"; std::cout << "\n\n";
	std::cout << "-------------------------------- Provides each web page's <head> section links to the style sheet and JavaScript file.--------------------------------------------------------";
	std::cout << "--------------------------------------------------------------------------------------------";
	std::cout << "\n\n"; 	  std::cout << "***************************************************************************************************************************************************************************";  std::cout << "\n\n";
	std::cout << "----------------------------------------------------------Demonstration of Requirement 7----------------------------------------------------------------------------"; std::cout << "\n\n";
	std::cout << "---------------------------------- Embedded HTML5 links to dependent files with a label, at the top of the web page.--------------------------------------------------------------------------";
	std::cout << "\n\n"; 	  std::cout << "***************************************************************************************************************************************************************************";  std::cout << "\n\n";
	std::cout << "----------------------------------------------------------Demonstration of Requirement 8----------------------------------------------------------------------------"; std::cout << "\n\n";
	std::cout << "----------------------------------Developed command line processing to define the files to publish by specifying path and file patterns.--------------------------------------------------------------------------";
	std::cout << "\n\n"; 	  std::cout << "***************************************************************************************************************************************************************************";  std::cout << "\n\n";
	std::cout << "----------------------------------------------------------Demonstration of Requirement 9----------------------------------------------------------------------------"; std::cout << "\n\n";
	std::cout << "---------------------------------- Demonstrated the CodePublisher functionality by publishing all the important packages.--------------------------------------------------------------------------";
	std::cout << "\n\n"; 	  std::cout << "***************************************************************************************************************************************************************************";  std::cout << "\n\n";
	std::cout << "----------------------------------------------------------Demonstration of Requirement 10----------------------------------------------------------------------------"; std::cout << "\n\n";
	std::cout << "----------------------------------Included an automated unit test suite that demonstrates all the requirements of this project--------------------------------------------------------------------------";
	std::cout << "\n\n"; 	  std::cout << "***************************************************************************************************************************************************************************";  std::cout << "\n\n";
  }
